...
void VulkanTriangle::drawFrame() {
  ...
  // submit the acquired image to the command buffer
  ...
  // submit the result back to the swap chain to have it eventually
...
/**
 * @brief create the image available and render finished semaphores
 */
void VulkanTriangle::createSemaphores() {
  VkSemaphoreCreateInfo semaphoreInfo{};
  semaphoreInfo.sType = VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO;  // may be deprecated
